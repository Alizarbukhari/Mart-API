...
from app.models.inventory_model import InventoryItem ,InventryUpdate
...
def update_inventory_item_by_id(product_id: int, to_update_product_data:InventryUpdate, session: Session):
