...
from app.crud.inventory_crud import add_new_inventory_item, delete_inventory_item_by_id, get_all_inventory_items, get_inventory_item_by_id ,InventryUpdate ,update_inventory_item_by_id
...
@app.get("/")
def read_root():
    return {"Hello": "Inventry service Service"}
...
def update_single_inventory_item(item_id: int, item: InventryUpdate, session: Annotated[Session, Depends(get_session)]):
