...
async def add_new_product(product: Product, session: Session [Annotated, Depends(get_session)], producer: Annotated[AIOKafkaProducer, Depends(get_kafka_producer)]):
